...
\begin{document}
    ...
    % HDSI Capstone Project (Hao Zhang)
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Built end-to-end distributed training stack for a 1.8B-parameter language model on 8 NVIDIA B200 GPUs, implementing pipeline parallelism and studying scaling laws firsthand.
            \item Extending to inference efficiency: developing TPU-optimized speculative decoding to reduce latency for test-time reasoning systems.
        \end{highlights}
    \end{onecolentry}
    \vspace{0.20 cm}

    % AR-Bench Research (Yian Ma)
    \begin{twocolentry}{\textit{Sep. 2025 -- Present}}
        \textbf{Student Researcher | Halıcıo\u{g}lu Data Science Institute, UC San Diego}\\
