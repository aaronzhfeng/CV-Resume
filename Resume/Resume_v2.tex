...
%------------------------------------------------------------------------------
%  One-page Resume - Condensed from CV
%  Using RenderCV style - maintaining format integrity
%------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------
%  Layout settings - same as CV for consistency
%------------------------------------------------------------------------------
...
\titlespacing{\section}{-1pt}{0.25 cm}{0.18 cm}
...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item GPA: 3.83 (Major GPAs: 3.94 in Data Science, 3.93 in Statistics) | Provost Honors
        \end{highlights}
    \end{onecolentry}

    %--------------------------------------------------------------------------
    %  Publications - same format as CV
    %--------------------------------------------------------------------------
    ...
    \begin{onecolentry}
        ...
        \textit{Under review at International Conference on Learning Representations (ICLR)}, 2026. \hfill {\color{black}\href{https://arxiv.org/abs/2509.04439}{[Paper]}} {\color{black}\href{https://github.com/matt-seb-ho/arc_memo}{[Code]}}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        ...
        \textit{Accepted at IEEE IROS 2025 Workshop on Embodied AI and Robotics for Future Scientific Discovery (AIR4S)}, 2025. \hfill {\color{black}\href{https://github.com/aaronzhfeng/lab_memo}{[Code]}}
    \end{onecolentry}

    %--------------------------------------------------------------------------
    %  Research Experience - same format as CV, fewer bullets
    %--------------------------------------------------------------------------
    ...
    \begin{twocolentry}{Jul. 2023 -- Sep. 2023}
        \textbf{Marketing Assistant | Sinotrans Limited}\\
        \textit{Tangshan, China}
    \end{twocolentry}
    \vspace{0.08 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Coordinated bulk commodity shipping operations, facilitating seamless communication between shipowners and cargo owners.
            \item Managed customs clearance processes and documentation for international shipping logistics.
        \end{highlights}
    \end{onecolentry}

    %--------------------------------------------------------------------------
    %  Technical Skills - same format as CV
    %--------------------------------------------------------------------------
    \section{Technical Skills}

    \begin{onecolentry}
        \textbf{Languages \& Frameworks:} Python, PyTorch, PyTorch Geometric, Transformers, scikit-learn, R, SQL, Java\\[2pt]
        \textbf{LLM/ML:} OpenAI APIs, LLM fine-tuning (PPO, DPO), RAG systems, memory-augmented LLMs, prompt engineering\\[2pt]
